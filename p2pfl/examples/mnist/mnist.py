    ...
    try:
        ...
        runtime_ledger = RuntimeLedgerAdapter(
            RuntimeLedgerConfig(
                ...
                trust_observation_only=config.trust.observation_only,
                selection_strategy=config.participant_selection.mode,
                validator_eligible_participants=config.participant_selection.eligible_participants,
